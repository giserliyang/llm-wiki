...
status: 未读
created: 2026-09-21
source_url: https://www.bilibili.com/video/BV1tDsgzxECr/?spm_id_from=333.1387.search.video_card.click&vd_source=14b8ba751d41ecbad5e65276e0baa1c6
author: 尚硅谷
---
...
| ![document_image_rId4.png](images/document_image_rId4.png) |
| :--------------------------------------------------------: |
|                           计算机硬件                            |
...
| ![document_image_rId5.png](images/document_image_rId5.png) |
| :-------------------------------------------------: |
|                        计算机软件                        |
...
| ![document_image_rId6.png](images/document_image_rId6.png) |
| :-------------------------------------------------: |
|                     计算机语言、代码、程序                     |
...
| ![document_image_rId7.png\|288](images/document_image_rId7.png) | ![document_image_rId8.png\|310](images/document_image_rId8.png)<br> |
| :-------------------------------------------------------------: | :-----------------------------------------------------------------: |
|                            世界第一台计算机                             |                              世界第一台计算机                               |
...
| ![document_image_rId9.png](images/document_image_rId9.png) |
| :--------------------------------------------------------: |
|                           编译型语言                            |
...
| ![document_image_rId10.png](images/document_image_rId10.png) |
| :----------------------------------------------------------: |
|                            解释型语言                             |
...
| ![document_image_rId11.png](images/document_image_rId11.png) | Python 的作者 Guido van Rossum 来自荷兰（国内爱称：龟叔），拥有数学与计算机背景，他发现用： C、Fortran 等语言写程序太费劲，而 Shell 虽然轻松，但功能却很有限。<br>1989 年圣诞节，龟叔开始动手编写一种既能像 C 那样全面操控系统，又能像 Shell 一样好上手的解释器，并以他喜爱的喜剧《Monty Python’s Flying Circus》为灵感，命名为“Python”。 |
| ------------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
![document_image_rId12.png](images/document_image_rId12.png)

**Python 的缺点：**

![document_image_rId13.png](images/document_image_rId13.png)
...
1. 1️⃣进入官网，点击 Downloads，选择对应的操作系统。   
   ![document_image_rId14.png|453](images/document_image_rId14.png)
2. 2️⃣选择版本，点击链接下载，我们这里的版本是 3.13.4。  
   ![document_image_rId15.png|453](images/document_image_rId15.png)
3. 3️⃣双击下载好的文件，开始安装（强烈建议以管理员身份运行）。
   ![document_image_rId16.png|315](images/document_image_rId16.png)![document_image_rId17.png|457](images/document_image_rId17.png)
4. 4️⃣保持默认，点击 Next。
   ![document_image_rId18.png|453](images/document_image_rId18.png)
5. 5️⃣修改安装路径，其他保持默认，点击 Install 开始安装。![document_image_rId19.png|452](images/document_image_rId19.png)
6. 6️⃣禁用系统路径长度限制
   建议点击 Disable path length limit，这样可以禁用系统的路径长度限制，以避免因路径过长而导致的错误，随后点击 Close，完成安装。![document_image_rId20.png|452](images/document_image_rId20.png)
7. 7️⃣检查是否安装成功，同时按下 Win 键和 R ，输入 cmd ，点击确定，进入命令提示符。
   ![document_image_rId21.png|410](images/document_image_rId21.png)
8. 8️⃣输入 python --version，若能打印出 Python 版本，则表示安装成功。
   ![document_image_rId22.png|373](images/document_image_rId22.png)

### 2.2. 一个简单的打印效果

1. 在终端中输入`python`并回车![document_image_rId23.png|457](images/document_image_rId23.png)
2. 随后输入：`print(100)`，随后回车，终端中呈现`100`![document_image_rId24.png|459](images/document_image_rId24.png)
...
1. 1️⃣进入官网，点击左下角 Download 下载 PyCharm 安装包（此处下载的是完整版安装包）。
   ![document_image_rId26.png|430](images/document_image_rId26.png)
> [!tip]
...
2. 2️⃣以管理员身份运行安装包文件，点击下一步进行安装
   ![document_image_rId27.png|413](images/document_image_rId27.png)
3. 3️⃣修改安装目录，点击下一步。![document_image_rId28.png|415](images/document_image_rId28.png)
4. 4️⃣勾选对应的安装选项，之后点击下一步。![document_image_rId29.png|413](images/document_image_rId29.png)
5. 5️⃣点击安装。
   ![document_image_rId30.png|372](images/document_image_rId30.png)
6. 6️⃣安装完成。
   ![document_image_rId31.png|376](images/document_image_rId31.png)
...
![document_image_rId32.png|396](images/document_image_rId32.png)

提示是否共享数据，若共享就会将部分使用数据发送给 Jetbrains公司优化产品，我这里选择不共享。
![document_image_rId33.png|398](images/document_image_rId33.png)

#### 二、创建项目

1. 1️⃣点击新建项目
   ![document_image_rId34.png|415](images/document_image_rId34.png)
2. 2️⃣设置项目名称，项目路径，解释器类型，Python版本。![document_image_rId35.png|408](images/document_image_rId35.png)
  > [!tip]
>    **📢注意**：不同的 pycharm 版本，这里看到的界面可能会略有不同。
>    
3. 3️⃣一个 Python 项目创建成功。![document_image_rId36.png|425](images/document_image_rId36.png)
4. 4️⃣若出现如下提示，点击【排除文件夹】即可
   ![document_image_rId37.png|423](images/document_image_rId37.png)

#### 三、字体设置

1. 1️⃣参考下图调整编辑器字体
   ![document_image_rId38.png|508](images/document_image_rId38.png)
2. 2️⃣若出现如下提示，则表示当前字体遵循主题设置，需要点击蓝色文字，跳转到配色方案中进行调整。
   ![document_image_rId39.png|510](images/document_image_rId39.png)
   ![document_image_rId40.png|511](images/document_image_rId40.png)

#### 四、主题设置

1. 1️⃣打开设置面板。
   ![document_image_rId41.png|456](images/document_image_rId41.png)
2. 2️⃣依次选择：外观 → 主题。![document_image_rId42.png|461](images/document_image_rId42.png)
3. 3️⃣滑动到最后，点击获取更多主题，可以从主题商店中安装新主题。![document_image_rId43.png|517](images/document_image_rId43.png)
   ![document_image_rId44.png|520](images/document_image_rId44.png)
#### 五、默认快捷键
PyCharm 中常用的默认快捷键如下：
...
1. 1️⃣按照图示方式，找到对应设置：
   ![document_image_rId45.png](images/document_image_rId45.png)
2. 2️⃣选择：添加鼠标快捷方式
   ![document_image_rId46.png](images/document_image_rId46.png)
3. 3️⃣弹出如下窗口后，按住ctrl键的同时，将鼠标滚轮向下滚动（当然向上也可以，根据个人习惯来）
   ![document_image_rId47.png](images/document_image_rId47.png)
4. 4️⃣随后窗口中会自动识别当前按下的按键和鼠标动作，随后点击确定即可。
   ![document_image_rId48.png](images/document_image_rId48.png)
5. 5️⃣再以同样的方式，设置让字体变大的快捷键
   ![document_image_rId49.png](images/document_image_rId49.png)
> [!tip]
...
![document_image_rId50.png](images/document_image_rId50.png)

### 3.2. 脚本模式

1.  在桌面上新建一个code文件夹，随后新建一个文本档，将其重命名为test.py
   ![document_image_rId51.png|355](images/document_image_rId51.png)
   ![document_image_rId52.png|435](images/document_image_rId52.png)
2.  使用记事本打开test.py，在其中写好代码并保存。
   ![document_image_rId53.png|380](images/document_image_rId53.png)
3.  找到test.py所在的文件夹
   ![document_image_rId54.png|474](images/document_image_rId54.png)
4.  在资源管理器上方输入cmd并回车，就会打开命令提示符并进入当前路径。
   ![document_image_rId55.png|421](images/document_image_rId55.png)![document_image_rId56.png|496](images/document_image_rId56.png)
5.  在命令提示符中输入python test.py执行程序，就会看到打印的内容。
   ![document_image_rId57.png|470](images/document_image_rId57.png)

### 3.3. IDE模式

1.  鼠标右键工程文件夹，选择新建 python 文件。   ![document_image_rId58.png|487](images/document_image_rId58.png)
2.  输入文件名，确认后按下回车![document_image_rId59.png](images/document_image_rId59.png)
3.  输入`print(100)`，随后在文件空白处点击鼠标右键，选择：`运行test`。![document_image_rId60.png](images/document_image_rId60.png)
...
| ![document_image_rId61.png](images/document_image_rId61.png) | ![document_image_rId62.png](images/document_image_rId62.png) | ![document_image_rId63.png](images/document_image_rId63.png) |
| ------------------------------------------------------------ | ------------------------------------------------------------ | ------------------------------------------------------------ |
...
💡Python 中推荐使用『蛇形（snake_case）』写法。
   ...
   举几个例子：
   ![document_image_rId64.png](images/document_image_rId64.png)
...
![document_image_rId65.png](images/document_image_rId65.png)
...
3. 3️⃣**整型上限值**
   ...
   通过幂运算，构建一个很大的数，随后打印它，我们会发现：代码报错了。
	...
	print(a)  # 打印x
	```
![document_image_rId66.png](images/document_image_rId66.png)
...
![document_image_rId68.png](images/document_image_rId68.png)
![document_image_rId67.png](images/document_image_rId67.png)
![document_image_rId69.png](images/document_image_rId69.png)
示例代码：
	```python
...
| **函数**       | **说明**       | **示例**                                                       |
| ------------ | ------------ | ------------------------------------------------------------ |
| **int(x)**   | 将x转换为一个整数    | ![document_image_rId70.png](images/document_image_rId70.png) |
| **float(x)** | 将x转换为一个浮点数   | ![document_image_rId71.png](images/document_image_rId71.png) |
| **str(x)**   | 将对象x转换为一个字符串 | ![document_image_rId72.png](images/document_image_rId72.png) |
...
常用的算数运算符如下：
![document_image_rId73.png](images/document_image_rId73.png)
...
常用的赋值运算符如下：
![document_image_rId74.png](images/document_image_rId74.png)
...
常用的比较运算符如下：
![document_image_rId75.png](images/document_image_rId75.png)
...
> ![document_image_rId76.png](images/document_image_rId76.png)
> 
...
![document_image_rId77.png](images/document_image_rId77.png)

但布尔类型的具体值，只有两个，分别是：`True`和`False`，其中：`True`表示真，`False`表示假。
![document_image_rId78.png|378](images/document_image_rId78.png)
...
常用的逻辑运算符如下：
![document_image_rId79.png](images/document_image_rId79.png)
...
| ![document_image_rId80.png\|309](images/document_image_rId80.png) | ![document_image_rId81.png\|298](images/document_image_rId81.png) |
| :---------------------------------------------------------------: | :---------------------------------------------------------------: |
|                             十进制数：9527                             |                             二进制数：1010                             |
| ![document_image_rId82.png\|309](images/document_image_rId82.png) | ![document_image_rId83.png\|303](images/document_image_rId83.png) |
|                             八进制数：1034                             |                             十六进制数：1CF                             |
...
> 十进制转十六进制：不断用 16 去除这个数，直到商为 0，把每次的余数倒着写，若余数 ≥ 10，则依次用 A、B、C、D、E、F 表示 10~15。
	...
	![document_image_rId84.png](images/document_image_rId84.png)

2. 2️⃣借助 Python 提供的内置函数，实现进制转换
![document_image_rId85.png](images/document_image_rId85.png)
...
1. **1️⃣语法格式：**
	...
	```
2. **2️⃣语法图解：**
![document_image_rId86.png|584](images/document_image_rId86.png)
...
```
**2️⃣语法图解：**
![document_image_rId88.png|441](images/document_image_rId87.png)
...
**2️⃣语法图解：**
![document_image_rId88.png|340](images/document_image_rId88.png)
...
**2️⃣语法图解：**
![document_image_rId89.png|423](images/document_image_rId89.png)

**3️⃣案例：**
![document_image_rId90.png|464](images/document_image_rId90.png)
...
**4️⃣案例：**
![document_image_rId91.png|439](images/document_image_rId91.png)
...
![document_image_rId92.png|460](images/document_image_rId92.png)
...
### 2.3. 对比 while 与 for
![document_image_rId93.png](images/document_image_rId93.png)
...
![document_image_rId94.png|421](images/document_image_rId94.png)
...
案例效果如图：
![document_image_rId95.png|486](images/document_image_rId95.png)
...
### 2.7. 综合案例
![document_image_rId96.png|547](images/document_image_rId96.png)
...
> 
> | ![document_image_rId97.png](images/document_image_rId97.png) |
> | :----------------------------------------------------------: |
> |                         智能家居场景 VS 函数                         |
> 

使用函数的主要优势：
![document_image_rId98.png|490](images/document_image_rId98.png)

### 1.2. Python 中函数的分类

Python 中函数分为三类：①内置函数、②模块提供的函数、③自定义函数。
![document_image_rId99.png](images/document_image_rId99.png)
...
**2️⃣语法图解：**
![document_image_rId102.png|511](images/document_image_rId102.png)
...
![document_image_rId103.png|260](images/document_image_rId103.png)
...
![document_image_rId104.png|458](images/document_image_rId104.png)
...
> ![document_image_rId105.png](images/document_image_rId105.png)
> 
...
我们之前用过的这些内置函数，都有返回值：
![document_image_rId107.png|470](images/document_image_rId107.png)
...
2.  **全局变量：** 写在全局作用域中的变量，就叫：全局变量，全局变量在整个程序中都可以访问。
   ![document_image_rId108.png|463](images/document_image_rId108.png)
### 5.3. 局部作用域 _ 局部变量

1.  **局部作用域：** 函数的内部范围，就是局部作用域。

2.  **局部变量：** 写在局部作用域中（函数内部）的变量，叫：局部变量，它只能在当前函数中使用。
   ![document_image_rId109.png|485](images/document_image_rId109.png)
...
![document_image_rId110.png|417](images/document_image_rId110.png)


## 9. 函数综合案例

完成一个健身挑战赛程序，功能演示见下图：
![document_image_rId111.png|357](images/document_image_rId111.png)
...
![document_image_rId112.png](images/document_image_rId112.png)
...
![document_image_rId113.png|389](images/document_image_rId113.png)
...
| ![document_image_rId114.png\|420](images/document_image_rId114.png) |
| :-----------------------------------------------------------------: |
|                                 正索引                                 |
| ![document_image_rId115.png\|423](images/document_image_rId115.png) |
|                                 负索引                                 |
...
![document_image_rId116.png|261](images/document_image_rId116.png)


在上述写法中，如果只看`append(元素)`，这就是在调用`append`函数，但`append`前面还有`列表`.这种形式，所以也可以换一个说法，叫：调用列表的`append`方法。
![document_image_rId117.png|400](images/document_image_rId117.png)
...
列表的增删改查方法概览：
![document_image_rId118.png](images/document_image_rId118.png)
...
![document_image_rId119.png](images/document_image_rId119.png)
...
![document_image_rId120.png](images/document_image_rId120.png)
...
![document_image_rId121.png|233](images/document_image_rId121.png)
...
![document_image_rId122.png|427](images/document_image_rId122.png)
...
![document_image_rId123.png](images/document_image_rId123.png)
...
![document_image_rId124.png](images/document_image_rId124.png)
...
| ![document_image_rId125.png](images/document_image_rId125.png) | ![document_image_rId126.png](images/document_image_rId126.png) |
| -------------------------------------------------------------- | -------------------------------------------------------------- |
| 人类                                                             | 汽车类                                                            |
...
| ![document_image_rId127.png\|285](images/document_image_rId127.png) | ![document_image_rId128.png\|323](images/document_image_rId128.png) |
| :-----------------------------------------------------------------: | :-----------------------------------------------------------------: |
...
完成一个学生成绩管理小案例
![document_image_rId130.png|365](images/document_image_rId130.png)
...
![document_image_rId131.png](images/document_image_rId131.png)
...
![document_image_rId132.png](images/document_image_rId132.png)


3️⃣ 可变对象：修改内容不改变地址
![document_image_rId133.png](images/document_image_rId133.png)


4️⃣自定义类对象的内存表示
![document_image_rId134.png](images/document_image_rId134.png)
...
![document_image_rId135.png|463](images/document_image_rId135.png)
...
welcome()  
```
![document_image_rId136.png|453](images/document_image_rId136.png)
3️⃣函数可以赋值给变量。
```python
def welcome():  
print('你好啊！')  
...
```
上述代码的内存结构示意图：
![document_image_rId137.png|438](images/document_image_rId137.png)
...
![document_image_rId138.png](images/document_image_rId138.png)
### 10.3. 浅拷贝
...
print(nums2[3]) # 99  
```
![document_image_rId139.png](images/document_image_rId139.png)
...
```
![document_image_rId140.png](images/document_image_rId140.png)
### 10.4. 深拷贝
...
print(nums2[3][0])  
```
![document_image_rId141.png](images/document_image_rId141.png)
...
![document_image_rId142.png](images/document_image_rId142.png)
...
![document_image_rId148.png|568](images/document_image_rId148.png)
...
![document_image_rId149.png](images/document_image_rId149.png)
在`cmd`中不做任何处理，直接通过`pip`安装的包，都是安装在了全局环境中，如果想在虚拟环境中安装包，需要切到虚拟环境目录后，通过`activate`命令切换到虚拟环境。

> 备注：使用`deactivate`可以退出虚拟环境。

![document_image_rId150.png|476](images/document_image_rId150.png)


## 3. 创建全局环境项目

通过 Pycharm 创建项目时，进行如下配置，即可创建全局环境：
![document_image_rId151.png|576](images/document_image_rId151.png)
...
![document_image_rId152.png|554](images/document_image_rId152.png)
...
先切换到虚拟环境
![document_image_rId153.png|581](images/document_image_rId153.png)


随后会切换到虚拟环境
![document_image_rId154.png|549](images/document_image_rId154.png)


随后安装自己想要的包（例如：faker）
![document_image_rId155.png|523](images/document_image_rId155.png)


2️⃣通过 Pycharm 中的命令行窗口安装

在 Pycharm 中打开命令行，会自动激活当前目录的虚拟环境
![document_image_rId156.png|473](images/document_image_rId156.png)


随后安装自己想要的包（例如：jieba）
![document_image_rId157.png|559](images/document_image_rId157.png)


3️⃣通过 Pycharm 提供的可视化工具安装

点击 Pycharm 右下角，随后选择解析器设置
![document_image_rId158.png](images/document_image_rId158.png)

随后点击加号
![document_image_rId159.png](images/document_image_rId159.png)

在搜索框里输入自己想安装的包（例如：cn2an），随后点击安装即可
![document_image_rId160.png](images/document_image_rId160.png)
...
| ![document_image_rId161.png](images/document_image_rId161.png) | ![document_image_rId162.png](images/document_image_rId162.png) |
| -------------------------------------------------------------- | -------------------------------------------------------------- |
...
3️⃣示例代码：
![document_image_rId87.png](images/document_image_rId87.png)
...
![document_image_rId163.png](images/document_image_rId163.png)

GIl 锁何时会被释放？ —— 主动释放（遇到 I/O 操作）、被迫释放（任务超时）
![document_image_rId164.png](images/document_image_rId164.png)

可以使用多进程来发挥多核 CPU 的性能
![document_image_rId165.png](images/document_image_rId165.png)

GIL 对比 lock/Rlock：
![document_image_rId166.png](images/document_image_rId166.png)
...
![document_image_rId167.png](images/document_image_rId167.png)
...
![document_image_rId168.png](images/document_image_rId168.png)
...
> Templater `gen-reading-progress` 生成；未勾选 → [[dashboards/素材收件箱]]。

- [ ] [[20260921_Python教程_尚硅谷#第 1 章 必备基础知识|第 1 章 必备基础知识]]
	- [ ] [[20260921_Python教程_尚硅谷#1. 计算机组成|1. 计算机组成]]
		- [ ] [[20260921_Python教程_尚硅谷#1.1. 硬件|1.1. 硬件]]
		- [ ] [[20260921_Python教程_尚硅谷#1.2. 软件|1.2. 软件]]
	- [ ] [[20260921_Python教程_尚硅谷#2. 计算机语言、代码、程序|2. 计算机语言、代码、程序]]
		- [ ] [[20260921_Python教程_尚硅谷#2.1. 计算机语言|2.1. 计算机语言]]
		- [ ] [[20260921_Python教程_尚硅谷#2.2. 代码|2.2. 代码]]
		- [ ] [[20260921_Python教程_尚硅谷#2.3. 程序|2.3. 程序]]
	- [ ] [[20260921_Python教程_尚硅谷#3. 计算机语言简史|3. 计算机语言简史]]
		- [ ] [[20260921_Python教程_尚硅谷#3.1. 第一代语言：机器语言|3.1. 第一代语言：机器语言]]
		- [ ] [[20260921_Python教程_尚硅谷#3.2. 第二代语言：汇编语言|3.2. 第二代语言：汇编语言]]
		- [ ] [[20260921_Python教程_尚硅谷#3.3. 第三代语言：高级语言|3.3. 第三代语言：高级语言]]
	- [ ] [[20260921_Python教程_尚硅谷#4. 『编译型语言』与『解释型语言』|4. 『编译型语言』与『解释型语言』]]
		- [ ] [[20260921_Python教程_尚硅谷#4.1. 编译型语言|4.1. 编译型语言]]
		- [ ] [[20260921_Python教程_尚硅谷#4.2. 解释型语言|4.2. 解释型语言]]
		- [ ] [[20260921_Python教程_尚硅谷#4.3. 二者对比|4.3. 二者对比]]
- [ ] [[20260921_Python教程_尚硅谷#第 2 章 初识 Python|第 2 章 初识 Python]]
	- [ ] [[20260921_Python教程_尚硅谷#1. Python 概述|1. Python 概述]]
		- [ ] [[20260921_Python教程_尚硅谷#1.1. Python 的起源|1.1. Python 的起源]]
		- [ ] [[20260921_Python教程_尚硅谷#1.2. Python 的特点|1.2. Python 的特点]]
		- [ ] [[20260921_Python教程_尚硅谷#1.3. 为何 AI 领域广泛使用 Python ？|1.3. 为何 AI 领域广泛使用 Python ？]]
		- [ ] [[20260921_Python教程_尚硅谷#1.4. Python 的版本|1.4. Python 的版本]]
	- [ ] [[20260921_Python教程_尚硅谷#2. 搭建 Python 开发环境|2. 搭建 Python 开发环境]]
		- [ ] [[20260921_Python教程_尚硅谷#2.1. 安装 Python 解释器|2.1. 安装 Python 解释器]]
		- [ ] [[20260921_Python教程_尚硅谷#2.2. 一个简单的打印效果|2.2. 一个简单的打印效果]]
		- [ ] [[20260921_Python教程_尚硅谷#2.3. 安装 PyCharm|2.3. 安装 PyCharm]]
		- [ ] [[20260921_Python教程_尚硅谷#2.4. 设置 PyCharm|2.4. 设置 PyCharm]]
			- [ ] [[20260921_Python教程_尚硅谷#一、设置中文UI|一、设置中文UI]]
			- [ ] [[20260921_Python教程_尚硅谷#二、创建项目|二、创建项目]]
			- [ ] [[20260921_Python教程_尚硅谷#三、字体设置|三、字体设置]]
			- [ ] [[20260921_Python教程_尚硅谷#四、主题设置|四、主题设置]]
			- [ ] [[20260921_Python教程_尚硅谷#五、默认快捷键|五、默认快捷键]]
			- [ ] [[20260921_Python教程_尚硅谷#六、自定义快捷键|六、自定义快捷键]]
	- [ ] [[20260921_Python教程_尚硅谷#3. 运行 Python 程序的几种方式总结|3. 运行 Python 程序的几种方式总结]]
		- [ ] [[20260921_Python教程_尚硅谷#3.1. 命令行模式|3.1. 命令行模式]]
		- [ ] [[20260921_Python教程_尚硅谷#3.2. 脚本模式|3.2. 脚本模式]]
		- [ ] [[20260921_Python教程_尚硅谷#3.3. IDE模式|3.3. IDE模式]]
- [ ] [[20260921_Python教程_尚硅谷#第 3 章 Python 核心基础|第 3 章 Python 核心基础]]
	- [ ] [[20260921_Python教程_尚硅谷#1. 字面量|1. 字面量]]
		- [ ] [[20260921_Python教程_尚硅谷#1.1. 概述|1.1. 概述]]
		- [ ] [[20260921_Python教程_尚硅谷#1.2. 写法|1.2. 写法]]
	- [ ] [[20260921_Python教程_尚硅谷#2. 变量与常量|2. 变量与常量]]
		- [ ] [[20260921_Python教程_尚硅谷#2.1. 变量|2.1. 变量]]
		- [ ] [[20260921_Python教程_尚硅谷#2.2. 标识符命名规则|2.2. 标识符命名规则]]
		- [ ] [[20260921_Python教程_尚硅谷#2.3. 常量|2.3. 常量]]
	- [ ] [[20260921_Python教程_尚硅谷#3. 注释|3. 注释]]
		- [ ] [[20260921_Python教程_尚硅谷#3.1. 概述|3.1. 概述]]
		- [ ] [[20260921_Python教程_尚硅谷#3.2. 注释的作用|3.2. 注释的作用]]
		- [ ] [[20260921_Python教程_尚硅谷#3.3. 单行注释|3.3. 单行注释]]
		- [ ] [[20260921_Python教程_尚硅谷#3.4. 多行注释|3.4. 多行注释]]
		- [ ] [[20260921_Python教程_尚硅谷#3.5. 文件编码注释|3.5. 文件编码注释]]
	- [ ] [[20260921_Python教程_尚硅谷#4. 字符编码|4. 字符编码]]
		- [ ] [[20260921_Python教程_尚硅谷#4.1. 概述|4.1. 概述]]
		- [ ] [[20260921_Python教程_尚硅谷#4.2. 常见编码方式|4.2. 常见编码方式]]
	- [ ] [[20260921_Python教程_尚硅谷#5. 数据类型|5. 数据类型]]
		- [ ] [[20260921_Python教程_尚硅谷#5.1. 概述|5.1. 概述]]
		- [ ] [[20260921_Python教程_尚硅谷#5.2. 查看数据类型|5.2. 查看数据类型]]
		- [ ] [[20260921_Python教程_尚硅谷#5.3. 整型|5.3. 整型]]
		- [ ] [[20260921_Python教程_尚硅谷#5.4. 浮点型|5.4. 浮点型]]
		- [ ] [[20260921_Python教程_尚硅谷#5.5. 字符串|5.5. 字符串]]
	- [ ] [[20260921_Python教程_尚硅谷#6. 数据类型转换|6. 数据类型转换]]
		- [ ] [[20260921_Python教程_尚硅谷#6.1. 概述|6.1. 概述]]
		- [ ] [[20260921_Python教程_尚硅谷#6.2. 为什么要数据类型转换|6.2. 为什么要数据类型转换]]
		- [ ] [[20260921_Python教程_尚硅谷#6.3. 具体转换方式|6.3. 具体转换方式]]
	- [ ] [[20260921_Python教程_尚硅谷#7. 运算符|7. 运算符]]
		- [ ] [[20260921_Python教程_尚硅谷#7.1. 算数运算符|7.1. 算数运算符]]
		- [ ] [[20260921_Python教程_尚硅谷#7.2. 赋值运算符|7.2. 赋值运算符]]
		- [ ] [[20260921_Python教程_尚硅谷#7.3. 比较运算符|7.3. 比较运算符]]
		- [ ] [[20260921_Python教程_尚硅谷#7.4. 布尔类型|7.4. 布尔类型]]
		- [ ] [[20260921_Python教程_尚硅谷#7.5. 逻辑运算符|7.5. 逻辑运算符]]
	- [ ] [[20260921_Python教程_尚硅谷#8. 进制|8. 进制]]
		- [ ] [[20260921_Python教程_尚硅谷#8.1. 概述|8.1. 概述]]
		- [ ] [[20260921_Python教程_尚硅谷#8.2. 代码中如何表示不同进制|8.2. 代码中如何表示不同进制]]
		- [ ] [[20260921_Python教程_尚硅谷#8.3. 不同进制之间的转换|8.3. 不同进制之间的转换]]
	- [ ] [[20260921_Python教程_尚硅谷#9. 输入语句|9. 输入语句]]
- [ ] [[20260921_Python教程_尚硅谷#第 4 章 流程控制语句|第 4 章 流程控制语句]]
	- [ ] [[20260921_Python教程_尚硅谷#1. 分支|1. 分支]]
		- [ ] [[20260921_Python教程_尚硅谷#1.1. 单分支|1.1. 单分支]]
		- [ ] [[20260921_Python教程_尚硅谷#1.2. 双分支|1.2. 双分支]]
		- [ ] [[20260921_Python教程_尚硅谷#1.3. 多分支|1.3. 多分支]]
		- [ ] [[20260921_Python教程_尚硅谷#1.4. 嵌套分之|1.4. 嵌套分之]]
	- [ ] [[20260921_Python教程_尚硅谷#2. 循环|2. 循环]]
		- [ ] [[20260921_Python教程_尚硅谷#2.1. while 循环|2.1. while 循环]]
		- [ ] [[20260921_Python教程_尚硅谷#2.2. for 循环|2.2. for 循环]]
		- [ ] [[20260921_Python教程_尚硅谷#2.3. 对比 while 与 for|2.3. 对比 while 与 for]]
		- [ ] [[20260921_Python教程_尚硅谷#2.4. 嵌套循环|2.4. 嵌套循环]]
		- [ ] [[20260921_Python教程_尚硅谷#2.5. 九九乘法表案例|2.5. 九九乘法表案例]]
		- [ ] [[20260921_Python教程_尚硅谷#2.6. continue 与 break|2.6. continue 与 break]]
		- [ ] [[20260921_Python教程_尚硅谷#2.7. 综合案例|2.7. 综合案例]]
- [ ] [[20260921_Python教程_尚硅谷#第 5 章 函数入门|第 5 章 函数入门]]
	- [ ] [[20260921_Python教程_尚硅谷#1. 概念及分类|1. 概念及分类]]
		- [ ] [[20260921_Python教程_尚硅谷#1.1. 函数的概念|1.1. 函数的概念]]
		- [ ] [[20260921_Python教程_尚硅谷#1.2. Python 中函数的分类|1.2. Python 中函数的分类]]
	- [ ] [[20260921_Python教程_尚硅谷#2. 基本使用|2. 基本使用]]
		- [ ] [[20260921_Python教程_尚硅谷#2.1. 定义函数|2.1. 定义函数]]
		- [ ] [[20260921_Python教程_尚硅谷#2.2. 调用函数|2.2. 调用函数]]
	- [ ] [[20260921_Python教程_尚硅谷#3. 参数|3. 参数]]
		- [ ] [[20260921_Python教程_尚硅谷#3.1. 参数的作用|3.1. 参数的作用]]
		- [ ] [[20260921_Python教程_尚硅谷#3.2. 实参与形参|3.2. 实参与形参]]
		- [ ] [[20260921_Python教程_尚硅谷#3.3. 位置参数|3.3. 位置参数]]
		- [ ] [[20260921_Python教程_尚硅谷#3.4. 关键字参数|3.4. 关键字参数]]
		- [ ] [[20260921_Python教程_尚硅谷#3.5. 限制传参方式|3.5. 限制传参方式]]
		- [ ] [[20260921_Python教程_尚硅谷#3.6. 参数默认值|3.6. 参数默认值]]
		- [ ] [[20260921_Python教程_尚硅谷#3.7. 可变参数|3.7. 可变参数]]
		- [ ] [[20260921_Python教程_尚硅谷#3.8. 特殊的字面量 None|3.8. 特殊的字面量 None]]
	- [ ] [[20260921_Python教程_尚硅谷#4. 返回值|4. 返回值]]
		- [ ] [[20260921_Python教程_尚硅谷#4.1. 什么是返回值|4.1. 什么是返回值]]
		- [ ] [[20260921_Python教程_尚硅谷#4.2. 如何设置返回值|4.2. 如何设置返回值]]
	- [ ] [[20260921_Python教程_尚硅谷#5. 全局作用域 VS 局部作用域|5. 全局作用域 VS 局部作用域]]
		- [ ] [[20260921_Python教程_尚硅谷#5.1. 什么是作用域？|5.1. 什么是作用域？]]
		- [ ] [[20260921_Python教程_尚硅谷#5.2. 全局作用域 _ 全局变量|5.2. 全局作用域 _ 全局变量]]
		- [ ] [[20260921_Python教程_尚硅谷#5.3. 局部作用域 _ 局部变量|5.3. 局部作用域 _ 局部变量]]
		- [ ] [[20260921_Python教程_尚硅谷#5.4. global 关键字|5.4. global 关键字]]
		- [ ] [[20260921_Python教程_尚硅谷#5.5. 小测试|5.5. 小测试]]
	- [ ] [[20260921_Python教程_尚硅谷#6. 嵌套调用|6. 嵌套调用]]
	- [ ] [[20260921_Python教程_尚硅谷#7. 递归调用|7. 递归调用]]
	- [ ] [[20260921_Python教程_尚硅谷#8. 函数说明文档|8. 函数说明文档]]
	- [ ] [[20260921_Python教程_尚硅谷#9. 函数综合案例|9. 函数综合案例]]
- [ ] [[20260921_Python教程_尚硅谷#第 6 章 数据容器|第 6 章 数据容器]]
	- [ ] [[20260921_Python教程_尚硅谷#1. 概述|1. 概述]]
	- [ ] [[20260921_Python教程_尚硅谷#2. 列表|2. 列表]]
		- [ ] [[20260921_Python教程_尚硅谷#2.1. 概述|2.1. 概述]]
		- [ ] [[20260921_Python教程_尚硅谷#2.2. 定义列表|2.2. 定义列表]]
		- [ ] [[20260921_Python教程_尚硅谷#2.3. 下标（索引值）|2.3. 下标（索引值）]]
		- [ ] [[20260921_Python教程_尚硅谷#2.4. 列表的增删改查|2.4. 列表的增删改查]]
			- [ ] [[20260921_Python教程_尚硅谷#1️⃣新增|1️⃣新增]]
			- [ ] [[20260921_Python教程_尚硅谷#2️⃣删除|2️⃣删除]]
			- [ ] [[20260921_Python教程_尚硅谷#3️⃣修改|3️⃣修改]]
			- [ ] [[20260921_Python教程_尚硅谷#4️⃣查询|4️⃣查询]]
		- [ ] [[20260921_Python教程_尚硅谷#2.5. 列表的常用方法|2.5. 列表的常用方法]]
		- [ ] [[20260921_Python教程_尚硅谷#2.6. 列表的常用内置函数|2.6. 列表的常用内置函数]]
		- [ ] [[20260921_Python教程_尚硅谷#2.7. 列表的循环遍历|2.7. 列表的循环遍历]]
		- [ ] [[20260921_Python教程_尚硅谷#2.8. 列表特点总结|2.8. 列表特点总结]]
		- [ ] [[20260921_Python教程_尚硅谷#2.9. 列表小练习|2.9. 列表小练习]]
	- [ ] [[20260921_Python教程_尚硅谷#3. 元组|3. 元组]]
		- [ ] [[20260921_Python教程_尚硅谷#3.1. 概述|3.1. 概述]]
		- [ ] [[20260921_Python教程_尚硅谷#3.2. 定义元组|3.2. 定义元组]]
		- [ ] [[20260921_Python教程_尚硅谷#3.3. 读取数据|3.3. 读取数据]]
		- [ ] [[20260921_Python教程_尚硅谷#3.4. 元组不可修改|3.4. 元组不可修改]]
		- [ ] [[20260921_Python教程_尚硅谷#3.5. 元组的常用方法|3.5. 元组的常用方法]]
		- [ ] [[20260921_Python教程_尚硅谷#3.6. 元组的常用内置函数|3.6. 元组的常用内置函数]]
		- [ ] [[20260921_Python教程_尚硅谷#3.7. 元组的循环遍历|3.7. 元组的循环遍历]]
		- [ ] [[20260921_Python教程_尚硅谷#3.8. 解包列表或元组传参|3.8. 解包列表或元组传参]]
		- [ ] [[20260921_Python教程_尚硅谷#3.9. 元组特点总结|3.9. 元组特点总结]]
		- [ ] [[20260921_Python教程_尚硅谷#3.10. 元组 VS 列表|3.10. 元组 VS 列表]]
	- [ ] [[20260921_Python教程_尚硅谷#4. 字符串|4. 字符串]]
		- [ ] [[20260921_Python教程_尚硅谷#4.1. 概述|4.1. 概述]]
		- [ ] [[20260921_Python教程_尚硅谷#4.2. 字符串的特点|4.2. 字符串的特点]]
		- [ ] [[20260921_Python教程_尚硅谷#4.3. 字符串常用方法|4.3. 字符串常用方法]]
		- [ ] [[20260921_Python教程_尚硅谷#4.4. 字符串常用内置函数|4.4. 字符串常用内置函数]]
		- [ ] [[20260921_Python教程_尚硅谷#4.5. 遍历字符串|4.5. 遍历字符串]]
	- [ ] [[20260921_Python教程_尚硅谷#5. 序列的切片操作|5. 序列的切片操作]]
		- [ ] [[20260921_Python教程_尚硅谷#5.1. 概述|5.1. 概述]]
		- [ ] [[20260921_Python教程_尚硅谷#5.2. 基本语法|5.2. 基本语法]]
	- [ ] [[20260921_Python教程_尚硅谷#6. 序列的其他操作|6. 序列的其他操作]]
	- [ ] [[20260921_Python教程_尚硅谷#7. 集合|7. 集合]]
		- [ ] [[20260921_Python教程_尚硅谷#7.1. 概述|7.1. 概述]]
		- [ ] [[20260921_Python教程_尚硅谷#7.2. 定义集合|7.2. 定义集合]]
		- [ ] [[20260921_Python教程_尚硅谷#7.3. 增删改查|7.3. 增删改查]]
		- [ ] [[20260921_Python教程_尚硅谷#7.4. 常用方法|7.4. 常用方法]]
		- [ ] [[20260921_Python教程_尚硅谷#7.5. 集合的数学运算|7.5. 集合的数学运算]]
		- [ ] [[20260921_Python教程_尚硅谷#7.6. 集合的循环遍历|7.6. 集合的循环遍历]]
		- [ ] [[20260921_Python教程_尚硅谷#7.7. 集合特点总结|7.7. 集合特点总结]]
	- [ ] [[20260921_Python教程_尚硅谷#8. 字典|8. 字典]]
		- [ ] [[20260921_Python教程_尚硅谷#8.1. 概述|8.1. 概述]]
		- [ ] [[20260921_Python教程_尚硅谷#8.2. 定义字典|8.2. 定义字典]]
		- [ ] [[20260921_Python教程_尚硅谷#8.3. 字典的增删改查|8.3. 字典的增删改查]]
		- [ ] [[20260921_Python教程_尚硅谷#8.4. 字典的常用方法|8.4. 字典的常用方法]]
		- [ ] [[20260921_Python教程_尚硅谷#8.5. 字典的循环遍历|8.5. 字典的循环遍历]]
		- [ ] [[20260921_Python教程_尚硅谷#8.6. 字典总结|8.6. 字典总结]]
	- [ ] [[20260921_Python教程_尚硅谷#9. 数据容器_通用操作|9. 数据容器_通用操作]]
	- [ ] [[20260921_Python教程_尚硅谷#10. 数据容器_小练习|10. 数据容器_小练习]]
	- [ ] [[20260921_Python教程_尚硅谷#11. 数据容器_总结|11. 数据容器_总结]]
- [ ] [[20260921_Python教程_尚硅谷#第 7 章 面向对象|第 7 章 面向对象]]
	- [ ] [[20260921_Python教程_尚硅谷#1. 概述|1. 概述]]
		- [ ] [[20260921_Python教程_尚硅谷#1.1. 对象|1.1. 对象]]
		- [ ] [[20260921_Python教程_尚硅谷#1.2. 面向对象|1.2. 面向对象]]
		- [ ] [[20260921_Python教程_尚硅谷#1.3. 类|1.3. 类]]
		- [ ] [[20260921_Python教程_尚硅谷#1.4. 实例 VS 实例化|1.4. 实例 VS 实例化]]
	- [ ] [[20260921_Python教程_尚硅谷#2. 基本使用|2. 基本使用]]
		- [ ] [[20260921_Python教程_尚硅谷#2.1. 类的定义|2.1. 类的定义]]
		- [ ] [[20260921_Python教程_尚硅谷#2.2. 创建实例|2.2. 创建实例]]
		- [ ] [[20260921_Python教程_尚硅谷#2.3. 自定义方法（行为）|2.3. 自定义方法（行为）]]
	- [ ] [[20260921_Python教程_尚硅谷#3. 实例属性、类属性|3. 实例属性、类属性]]
		- [ ] [[20260921_Python教程_尚硅谷#3.1. 实例属性|3.1. 实例属性]]
		- [ ] [[20260921_Python教程_尚硅谷#3.2. 类属性|3.2. 类属性]]
	- [ ] [[20260921_Python教程_尚硅谷#4. 实例方法、类方法、静态方法|4. 实例方法、类方法、静态方法]]
		- [ ] [[20260921_Python教程_尚硅谷#4.1. 实例方法|4.1. 实例方法]]
		- [ ] [[20260921_Python教程_尚硅谷#4.2. 类方法|4.2. 类方法]]
		- [ ] [[20260921_Python教程_尚硅谷#4.3. 静态方法|4.3. 静态方法]]
	- [ ] [[20260921_Python教程_尚硅谷#5. 继承|5. 继承]]
		- [ ] [[20260921_Python教程_尚硅谷#5.1. 基本语法|5.1. 基本语法]]
		- [ ] [[20260921_Python教程_尚硅谷#5.2. 方法重写|5.2. 方法重写]]
		- [ ] [[20260921_Python教程_尚硅谷#5.3. `isinstance()`和 `issubclass()`|5.3. `isinstance()`和 `issubclass()`]]
		- [ ] [[20260921_Python教程_尚硅谷#5.4. 多重继承|5.4. 多重继承]]
	- [ ] [[20260921_Python教程_尚硅谷#6. 权限控制|6. 权限控制]]
		- [ ] [[20260921_Python教程_尚硅谷#6.1. 三种访问权限|6.1. 三种访问权限]]
		- [ ] [[20260921_Python教程_尚硅谷#6.2. getter 与 setter|6.2. getter 与 setter]]
	- [ ] [[20260921_Python教程_尚硅谷#7. 魔法方法|7. 魔法方法]]
	- [ ] [[20260921_Python教程_尚硅谷#8. object 类|8. object 类]]
	- [ ] [[20260921_Python教程_尚硅谷#9. 多态|9. 多态]]
		- [ ] [[20260921_Python教程_尚硅谷#9.1. 何为多态|9.1. 何为多态]]
		- [ ] [[20260921_Python教程_尚硅谷#9.2. 标准多态|9.2. 标准多态]]
		- [ ] [[20260921_Python教程_尚硅谷#9.3. 鸭子多态|9.3. 鸭子多态]]
	- [ ] [[20260921_Python教程_尚硅谷#10. 抽象类|10. 抽象类]]
	- [ ] [[20260921_Python教程_尚硅谷#11. 小练习|11. 小练习]]
	- [ ] [[20260921_Python教程_尚硅谷#12. 内存分析|12. 内存分析]]
- [ ] [[20260921_Python教程_尚硅谷#⬇️进阶篇⬇️|⬇️进阶篇⬇️]]
- [ ] [[20260921_Python教程_尚硅谷#第 8 章 函数进阶|第 8 章 函数进阶]]
	- [ ] [[20260921_Python教程_尚硅谷#1. 重新认识函数|1. 重新认识函数]]
	- [ ] [[20260921_Python教程_尚硅谷#2. 函数的多返回值|2. 函数的多返回值]]
	- [ ] [[20260921_Python教程_尚硅谷#3. 参数的打包与解包|3. 参数的打包与解包]]
	- [ ] [[20260921_Python教程_尚硅谷#4. 高阶函数|4. 高阶函数]]
	- [ ] [[20260921_Python教程_尚硅谷#5. 条件表达式|5. 条件表达式]]
	- [ ] [[20260921_Python教程_尚硅谷#6. 匿名函数|6. 匿名函数]]
	- [ ] [[20260921_Python教程_尚硅谷#7. 几个数据处理函数|7. 几个数据处理函数]]
		- [ ] [[20260921_Python教程_尚硅谷#7.1. map 函数|7.1. map 函数]]
		- [ ] [[20260921_Python教程_尚硅谷#7.2. filter 函数|7.2. filter 函数]]
		- [ ] [[20260921_Python教程_尚硅谷#7.3. sorted 函数|7.3. sorted 函数]]
		- [ ] [[20260921_Python教程_尚硅谷#7.4. reduce 函数|7.4. reduce 函数]]
	- [ ] [[20260921_Python教程_尚硅谷#8. 列表推导式|8. 列表推导式]]
	- [ ] [[20260921_Python教程_尚硅谷#9. 常用内置函数梳理|9. 常用内置函数梳理]]
		- [ ] [[20260921_Python教程_尚硅谷#9.1. 输入与输出|9.1. 输入与输出]]
		- [ ] [[20260921_Python教程_尚硅谷#9.2. 类型转换|9.2. 类型转换]]
		- [ ] [[20260921_Python教程_尚硅谷#9.3. 数学相关|9.3. 数学相关]]
		- [ ] [[20260921_Python教程_尚硅谷#9.4. 数据容器相关|9.4. 数据容器相关]]
		- [ ] [[20260921_Python教程_尚硅谷#9.5. 类型判断与对象相关|9.5. 类型判断与对象相关]]
		- [ ] [[20260921_Python教程_尚硅谷#9.6. 逻辑判断相关|9.6. 逻辑判断相关]]
		- [ ] [[20260921_Python教程_尚硅谷#9.7. 字符串辅助相关|9.7. 字符串辅助相关]]
	- [ ] [[20260921_Python教程_尚硅谷#10. 浅拷贝 vs 深拷贝|10. 浅拷贝 vs 深拷贝]]
		- [ ] [[20260921_Python教程_尚硅谷#10.1. 为什么要拷贝？|10.1. 为什么要拷贝？]]
		- [ ] [[20260921_Python教程_尚硅谷#10.2. 直接赋值|10.2. 直接赋值]]
		- [ ] [[20260921_Python教程_尚硅谷#10.3. 浅拷贝|10.3. 浅拷贝]]
		- [ ] [[20260921_Python教程_尚硅谷#10.4. 深拷贝|10.4. 深拷贝]]
	- [ ] [[20260921_Python教程_尚硅谷#11. 四种作用域|11. 四种作用域]]
		- [ ] [[20260921_Python教程_尚硅谷#11.1. 局部作用域（Local）|11.1. 局部作用域（Local）]]
		- [ ] [[20260921_Python教程_尚硅谷#11.2. 外层作用域（Enclosing）|11.2. 外层作用域（Enclosing）]]
		- [ ] [[20260921_Python教程_尚硅谷#11.3. 全局作用域（Global）|11.3. 全局作用域（Global）]]
		- [ ] [[20260921_Python教程_尚硅谷#11.4. 内建作用域（Built-in）|11.4. 内建作用域（Built-in）]]
	- [ ] [[20260921_Python教程_尚硅谷#12. 闭包|12. 闭包]]
		- [ ] [[20260921_Python教程_尚硅谷#12.1. 前置知识|12.1. 前置知识]]
		- [ ] [[20260921_Python教程_尚硅谷#12.2. 什么是闭包|12.2. 什么是闭包]]
		- [ ] [[20260921_Python教程_尚硅谷#12.3. 闭包的基本形式|12.3. 闭包的基本形式]]
		- [ ] [[20260921_Python教程_尚硅谷#12.4. 闭包是如何保存外层变量的？|12.4. 闭包是如何保存外层变量的？]]
		- [ ] [[20260921_Python教程_尚硅谷#12.5. 注意点|12.5. 注意点]]
		- [ ] [[20260921_Python教程_尚硅谷#12.6. 闭包的优点|12.6. 闭包的优点]]
		- [ ] [[20260921_Python教程_尚硅谷#12.7. 闭包的缺点|12.7. 闭包的缺点]]
	- [ ] [[20260921_Python教程_尚硅谷#13. 装饰器|13. 装饰器]]
		- [ ] [[20260921_Python教程_尚硅谷#13.1. 函数装饰器|13.1. 函数装饰器]]
			- [ ] [[20260921_Python教程_尚硅谷#1️⃣定义函数装饰器|1️⃣定义函数装饰器]]
			- [ ] [[20260921_Python教程_尚硅谷#2️⃣使用函数装饰器（手动装饰）|2️⃣使用函数装饰器（手动装饰）]]
			- [ ] [[20260921_Python教程_尚硅谷#3️⃣使用函数装饰器（语法糖 @）|3️⃣使用函数装饰器（语法糖 @）]]
			- [ ] [[20260921_Python教程_尚硅谷#4️⃣带参数的函数装饰器（三层嵌套）|4️⃣带参数的函数装饰器（三层嵌套）]]
			- [ ] [[20260921_Python教程_尚硅谷#5️⃣多个函数装饰器一起使用|5️⃣多个函数装饰器一起使用]]
		- [ ] [[20260921_Python教程_尚硅谷#13.2. 类装饰器|13.2. 类装饰器]]
			- [ ] [[20260921_Python教程_尚硅谷#1️⃣定义类装饰器|1️⃣定义类装饰器]]
			- [ ] [[20260921_Python教程_尚硅谷#2️⃣使用类装饰器（手动装饰）|2️⃣使用类装饰器（手动装饰）]]
			- [ ] [[20260921_Python教程_尚硅谷#3️⃣使用类装饰器（语法糖 @）|3️⃣使用类装饰器（语法糖 @）]]
			- [ ] [[20260921_Python教程_尚硅谷#4️⃣带参数的类装饰器|4️⃣带参数的类装饰器]]
			- [ ] [[20260921_Python教程_尚硅谷#5️⃣多个类装饰器一起使用|5️⃣多个类装饰器一起使用]]
	- [ ] [[20260921_Python教程_尚硅谷#14. 类型注解 vs 函数类型注解|14. 类型注解 vs 函数类型注解]]
		- [ ] [[20260921_Python教程_尚硅谷#14.1. 变量类型注解|14.1. 变量类型注解]]
		- [ ] [[20260921_Python教程_尚硅谷#14.2. 函数类型注解|14.2. 函数类型注解]]
- [ ] [[20260921_Python教程_尚硅谷#第 9 章 错误与异常|第 9 章 错误与异常]]
	- [ ] [[20260921_Python教程_尚硅谷#1. 错误与异常|1. 错误与异常]]
	- [ ] [[20260921_Python教程_尚硅谷#2. 异常处理|2. 异常处理]]
		- [ ] [[20260921_Python教程_尚硅谷#1️⃣为什么要进行异常处理|1️⃣为什么要进行异常处理]]
		- [ ] [[20260921_Python教程_尚硅谷#2️⃣异常处理（初级）|2️⃣异常处理（初级）]]
		- [ ] [[20260921_Python教程_尚硅谷#3️⃣捕获指定的类型的异常|3️⃣捕获指定的类型的异常]]
		- [ ] [[20260921_Python教程_尚硅谷#4️⃣验证异常类之间的继承关系|4️⃣验证异常类之间的继承关系]]
		- [ ] [[20260921_Python教程_尚硅谷#️5️⃣多个 except|️5️⃣多个 except]]
		- [ ] [[20260921_Python教程_尚硅谷#6️⃣获取异常的具体信息|6️⃣获取异常的具体信息]]
		- [ ] [[20260921_Python教程_尚硅谷#7️⃣一个 except 捕获不同的异常|7️⃣一个 except 捕获不同的异常]]
		- [ ] [[20260921_Python教程_尚硅谷#8️⃣完整写法|8️⃣完整写法]]
	- [ ] [[20260921_Python教程_尚硅谷#3. 手动抛出异常|3. 手动抛出异常]]
	- [ ] [[20260921_Python教程_尚硅谷#4. 异常的传递机制|4. 异常的传递机制]]
	- [ ] [[20260921_Python教程_尚硅谷#5. 自定义异常类|5. 自定义异常类]]
- [ ] [[20260921_Python教程_尚硅谷#第 10 章 模块与包|第 10 章 模块与包]]
	- [ ] [[20260921_Python教程_尚硅谷#1. 模块|1. 模块]]
		- [ ] [[20260921_Python教程_尚硅谷#1.1. 概述|1.1. 概述]]
		- [ ] [[20260921_Python教程_尚硅谷#1.2. 模块的分类|1.2. 模块的分类]]
		- [ ] [[20260921_Python教程_尚硅谷#1.3. 创建模块|1.3. 创建模块]]
		- [ ] [[20260921_Python教程_尚硅谷#1.4. 导入模块|1.4. 导入模块]]
			- [ ] [[20260921_Python教程_尚硅谷#1️⃣import 模块名|1️⃣import 模块名]]
			- [ ] [[20260921_Python教程_尚硅谷#2️⃣import 模块名 as 别名|2️⃣import 模块名 as 别名]]
			- [ ] [[20260921_Python教程_尚硅谷#3️⃣from 模块名 import 具体内容1, 具体内容2, ......|3️⃣from 模块名 import 具体内容1, 具体内容2, ......]]
			- [ ] [[20260921_Python教程_尚硅谷#4️⃣from 模块名 import 具体内容 as 别名|4️⃣from 模块名 import 具体内容 as 别名]]
			- [ ] [[20260921_Python教程_尚硅谷#5️⃣from 模块名 import *|5️⃣from 模块名 import *]]
		- [ ] [[20260921_Python教程_尚硅谷#1.5. `__all__ `与 `__name__`|1.5. `__all__ `与 `__name__`]]
		- [ ] [[20260921_Python教程_尚硅谷#1.6. 标准库模块|1.6. 标准库模块]]
	- [ ] [[20260921_Python教程_尚硅谷#2. 包|2. 包]]
		- [ ] [[20260921_Python教程_尚硅谷#2.1. 概述|2.1. 概述]]
		- [ ] [[20260921_Python教程_尚硅谷#2.2. 包与模块的关系|2.2. 包与模块的关系]]
		- [ ] [[20260921_Python教程_尚硅谷#2.3. 包的分类|2.3. 包的分类]]
		- [ ] [[20260921_Python教程_尚硅谷#2.4. 创建包|2.4. 创建包]]
		- [ ] [[20260921_Python教程_尚硅谷#2.5. 导入包|2.5. 导入包]]
			- [ ] [[20260921_Python教程_尚硅谷#1️⃣import 包名.模块名|1️⃣import 包名.模块名]]
			- [ ] [[20260921_Python教程_尚硅谷#2️⃣import 包名.模块名 as 别名|2️⃣import 包名.模块名 as 别名]]
			- [ ] [[20260921_Python教程_尚硅谷#3️⃣from 包名.模块名 import 具体内容1|3️⃣from 包名.模块名 import 具体内容1]]
			- [ ] [[20260921_Python教程_尚硅谷#4️⃣from 包名.模块名 import 具体内容 as 别名|4️⃣from 包名.模块名 import 具体内容 as 别名]]
			- [ ] [[20260921_Python教程_尚硅谷#5️⃣from 包名.模块名 import *|5️⃣from 包名.模块名 import *]]
			- [ ] [[20260921_Python教程_尚硅谷#6️⃣from 包名 import 模块名|6️⃣from 包名 import 模块名]]
			- [ ] [[20260921_Python教程_尚硅谷#7️⃣from 包名 import 模块名 as 别名|7️⃣from 包名 import 模块名 as 别名]]
			- [ ] [[20260921_Python教程_尚硅谷#⭐关于 `__init__.py` 文件|⭐关于 `__init__.py` 文件]]
			- [ ] [[20260921_Python教程_尚硅谷#8️⃣from 包名 import *|8️⃣from 包名 import *]]
			- [ ] [[20260921_Python教程_尚硅谷#9️⃣import 包名|9️⃣import 包名]]
		- [ ] [[20260921_Python教程_尚硅谷#2.6. 引入子包|2.6. 引入子包]]
		- [ ] [[20260921_Python教程_尚硅谷#2.7. 第三方包|2.7. 第三方包]]
			- [ ] [[20260921_Python教程_尚硅谷#1️⃣概述|1️⃣概述]]
			- [ ] [[20260921_Python教程_尚硅谷#2️⃣pip常用命令|2️⃣pip常用命令]]
			- [ ] [[20260921_Python教程_尚硅谷#3️⃣安装一个第三方包|3️⃣安装一个第三方包]]
			- [ ] [[20260921_Python教程_尚硅谷#4️⃣全局环境 vs 虚拟环境|4️⃣全局环境 vs 虚拟环境]]
	- [ ] [[20260921_Python教程_尚硅谷#3. 创建全局环境项目|3. 创建全局环境项目]]
	- [ ] [[20260921_Python教程_尚硅谷#4. 创建虚拟环境项目|4. 创建虚拟环境项目]]
- [ ] [[20260921_Python教程_尚硅谷#第 11 章 迭代器 vs 生成器|第 11 章 迭代器 vs 生成器]]
	- [ ] [[20260921_Python教程_尚硅谷#1. 迭代器|1. 迭代器]]
		- [ ] [[20260921_Python教程_尚硅谷#1️⃣可迭代对象（iterable）|1️⃣可迭代对象（iterable）]]
		- [ ] [[20260921_Python教程_尚硅谷#2️⃣迭代器（iterator）|2️⃣迭代器（iterator）]]
		- [ ] [[20260921_Python教程_尚硅谷#3️⃣迭代器的应用|3️⃣迭代器的应用]]
		- [ ] [[20260921_Python教程_尚硅谷#4️⃣迭代器的优势|4️⃣迭代器的优势]]
	- [ ] [[20260921_Python教程_尚硅谷#2. 生成器|2. 生成器]]
		- [ ] [[20260921_Python教程_尚硅谷#1️⃣两个概念|1️⃣两个概念]]
		- [ ] [[20260921_Python教程_尚硅谷#2️⃣几个细节|2️⃣几个细节]]
		- [ ] [[20260921_Python教程_尚硅谷#3️⃣生成器的应用|3️⃣生成器的应用]]
		- [ ] [[20260921_Python教程_尚硅谷#4️⃣生成器表达式|4️⃣生成器表达式]]
- [ ] [[20260921_Python教程_尚硅谷#第 12 章 文件操作|第 12 章 文件操作]]
	- [ ] [[20260921_Python教程_尚硅谷#1. 文件的分类|1. 文件的分类]]
		- [ ] [[20260921_Python教程_尚硅谷#1️⃣纯文本文件|1️⃣纯文本文件]]
		- [ ] [[20260921_Python教程_尚硅谷#2️⃣二进制文件|2️⃣二进制文件]]
	- [ ] [[20260921_Python教程_尚硅谷#2. 绝对路径 vs 相对路径|2. 绝对路径 vs 相对路径]]
		- [ ] [[20260921_Python教程_尚硅谷#1️⃣绝对路径：|1️⃣绝对路径：]]
		- [ ] [[20260921_Python教程_尚硅谷#2️⃣相对路径：|2️⃣相对路径：]]
	- [ ] [[20260921_Python教程_尚硅谷#3. Python 中操作文件的标准流程|3. Python 中操作文件的标准流程]]
	- [ ] [[20260921_Python教程_尚硅谷#4. 读取文件|4. 读取文件]]
		- [ ] [[20260921_Python教程_尚硅谷#1️⃣read方法|1️⃣read方法]]
		- [ ] [[20260921_Python教程_尚硅谷#2️⃣`readline`方法|2️⃣`readline`方法]]
		- [ ] [[20260921_Python教程_尚硅谷#3️⃣for 循环遍历文件对象|3️⃣for 循环遍历文件对象]]
		- [ ] [[20260921_Python教程_尚硅谷#4️⃣`readlines`方法|4️⃣`readlines`方法]]
		- [ ] [[20260921_Python教程_尚硅谷#⭐️最佳实践|⭐️最佳实践]]
	- [ ] [[20260921_Python教程_尚硅谷#5. 关于with|5. 关于with]]
	- [ ] [[20260921_Python教程_尚硅谷#6. 写入文件|6. 写入文件]]
		- [ ] [[20260921_Python教程_尚硅谷#1️⃣`w`模式|1️⃣`w`模式]]
		- [ ] [[20260921_Python教程_尚硅谷#2️⃣`x`模式|2️⃣`x`模式]]
		- [ ] [[20260921_Python教程_尚硅谷#3️⃣`a`模式|3️⃣`a`模式]]
	- [ ] [[20260921_Python教程_尚硅谷#7. `flush`方法|7. `flush`方法]]
	- [ ] [[20260921_Python教程_尚硅谷#8. 组合模式|8. 组合模式]]
		- [ ] [[20260921_Python教程_尚硅谷#1️⃣`rt+`模式|1️⃣`rt+`模式]]
		- [ ] [[20260921_Python教程_尚硅谷#2️⃣`wt+`模式|2️⃣`wt+`模式]]
		- [ ] [[20260921_Python教程_尚硅谷#3️⃣`xt+`模式|3️⃣`xt+`模式]]
		- [ ] [[20260921_Python教程_尚硅谷#3️⃣`at+`模式|3️⃣`at+`模式]]
	- [ ] [[20260921_Python教程_尚硅谷#9. 目录操作|9. 目录操作]]
	- [ ] [[20260921_Python教程_尚硅谷#10. 两个小练习|10. 两个小练习]]
- [ ] [[20260921_Python教程_尚硅谷#第 13 章 进程与线程|第 13 章 进程与线程]]
	- [ ] [[20260921_Python教程_尚硅谷#1. 一些核心概念|1. 一些核心概念]]
		- [ ] [[20260921_Python教程_尚硅谷#1️⃣并发 vs 并行|1️⃣并发 vs 并行]]
		- [ ] [[20260921_Python教程_尚硅谷#2️⃣ 同步 vs 异步|2️⃣ 同步 vs 异步]]
		- [ ] [[20260921_Python教程_尚硅谷#3️⃣进程 vs 线程|3️⃣进程 vs 线程]]
	- [ ] [[20260921_Python教程_尚硅谷#2. 主进程 _ 子进程|2. 主进程 _ 子进程]]
	- [ ] [[20260921_Python教程_尚硅谷#3. 使用 Process 创建进程|3. 使用 Process 创建进程]]
	- [ ] [[20260921_Python教程_尚硅谷#4. 关于 Process 的参数|4. 关于 Process 的参数]]
	- [ ] [[20260921_Python教程_尚硅谷#5. 进程控制|5. 进程控制]]
		- [ ] [[20260921_Python教程_尚硅谷#1️⃣Lock（进程锁）|1️⃣Lock（进程锁）]]
		- [ ] [[20260921_Python教程_尚硅谷#2️⃣ join 方法|2️⃣ join 方法]]
		- [ ] [[20260921_Python教程_尚硅谷#3️⃣terminate 方法|3️⃣terminate 方法]]
		- [ ] [[20260921_Python教程_尚硅谷#4️⃣ 守护进程 (Daemon)|4️⃣ 守护进程 (Daemon)]]
	- [ ] [[20260921_Python教程_尚硅谷#6. 进程之间不共享变量|6. 进程之间不共享变量]]
	- [ ] [[20260921_Python教程_尚硅谷#7. Queue（队列）|7. Queue（队列）]]
	- [ ] [[20260921_Python教程_尚硅谷#8. 使用 Queue 实现进程通信|8. 使用 Queue 实现进程通信]]
	- [ ] [[20260921_Python教程_尚硅谷#9. 使用 Pipe 实现进程通信|9. 使用 Pipe 实现进程通信]]
	- [ ] [[20260921_Python教程_尚硅谷#10. 继承 Process 类创建进程|10. 继承 Process 类创建进程]]
	- [ ] [[20260921_Python教程_尚硅谷#11. 进程池（ProcessPoolExecutor）|11. 进程池（ProcessPoolExecutor）]]
	- [ ] [[20260921_Python教程_尚硅谷#12. 使用 Thread 创建线程|12. 使用 Thread 创建线程]]
	- [ ] [[20260921_Python教程_尚硅谷#13. 继承 Thread 创建线程|13. 继承 Thread 创建线程]]
	- [ ] [[20260921_Python教程_尚硅谷#14. 线程池|14. 线程池]]
	- [ ] [[20260921_Python教程_尚硅谷#15. GIL 全局解释器锁|15. GIL 全局解释器锁]]
	- [ ] [[20260921_Python教程_尚硅谷#16. 多进程 vs 多线程，该如何选择？|16. 多进程 vs 多线程，该如何选择？]]
- [ ] [[20260921_Python教程_尚硅谷#第 14 章 协程|第 14 章 协程]]
	- [ ] [[20260921_Python教程_尚硅谷#1. 什么是协程|1. 什么是协程]]
	- [ ] [[20260921_Python教程_尚硅谷#2. 协程函数 vs 协程对象|2. 协程函数 vs 协程对象]]
	- [ ] [[20260921_Python教程_尚硅谷#3. await 关键字|3. await 关键字]]
	- [ ] [[20260921_Python教程_尚硅谷#4. 多个任务同步执行|4. 多个任务同步执行]]
	- [ ] [[20260921_Python教程_尚硅谷#5. 多个任务异步执行|5. 多个任务异步执行]]
	- [ ] [[20260921_Python教程_尚硅谷#6. asyncio.gather|6. asyncio.gather]]
	- [ ] [[20260921_Python教程_尚硅谷#7. 下载图片案例|7. 下载图片案例]]
